...
class IMDB:
    ...
    def fill_datas(self):
        try:
            ...
            page_topic_quote = self.wait.until(EC.element_to_be_clickable((By.XPATH,locators.IMDB_Locators().page_topic_test_xpath)))
            print("page topic defined")
            if not page_topic_quote.is_displayed():
            ...
            search = self.wait.until(EC.element_to_be_clickable((By.XPATH, locators.IMDB_Locators.search_xpath))).click()
